...
<<<<<<< HEAD
    ...
    mensaje = f"La serie temporal {'es' if estacionaria == True else 'no es'} estacionaria según el test de {nombre_test} con valor p= {result[1]}"
=======
...
>>>>>>> 96e4e463fa5999c10f3f8a2c92e204947e6a386d
    return mensaje